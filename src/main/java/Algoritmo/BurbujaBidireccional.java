 ...
 * @author andre
 */
public class BurbujaBidireccional extends javax.swing.JFrame {
    int[] numeros;
    int movimientos, comparaciones;
    long start, end;
    /**
     * Creates new form BurbujaBidireccional
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BurbujaBidireccional.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BurbujaBidireccional().setVisible(true);
            }
        });
    }
