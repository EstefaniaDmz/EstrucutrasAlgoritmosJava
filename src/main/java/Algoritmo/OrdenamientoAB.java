...
import Algoritmo.Clases.COrdenamientoAB;
 ...
 * @author andre
 */
public class OrdenamientoAB extends javax.swing.JFrame {
    int[] numeros;
    String ordenado;
    ...
    long start, end;
    /**
     * Creates new form OrdenamientoAB
     */
    public OrdenamientoAB() {
        initComponents();
        Limpiar();
    }
...
private void Imprimir()
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OrdenamientoAB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OrdenamientoAB().setVisible(true);
            }
        });
    }
