 ...
 * @author andre
 */
public class Inserccion extends javax.swing.JFrame {
 int[] numeros;
    int movimientos, comparaciones;
    long start, end;
    /**
     * Creates new form Inserccion
     */
    public Inserccion() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inserccion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Inserccion().setVisible(true);
            }
        });
    }
