 ...
 * @author andre
 */
public class MezclaDirecta extends javax.swing.JFrame {
    int[] numeros;
    int movimientos, comparaciones;
    long start, end;
    /**
     * Creates new form MezclaDirecta
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MezclaDirecta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MezclaDirecta().setVisible(true);
            }
        });
    }
