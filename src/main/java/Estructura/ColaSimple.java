...
import Estructura.Clases.CColaSimple;

/**
 *
 * @author andre
 */
public class ColaSimple extends javax.swing.JFrame {

    CColaSimple simple;
    
    /**
     * Creates new form ColaSimple
     */
    public ColaSimple() {
        initComponents();
        txtCola.setText("");
        txtDato.setText("");
        simple = new CColaSimple();
    }
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        simple.Agregar(txtDato.getText());
        txtCola.setText(simple.toString());
        txtDato.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ColaSimple.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ColaSimple().setVisible(true);
            }
        });
    }
