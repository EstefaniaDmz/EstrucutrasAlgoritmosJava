...
import Estructura.Clases.CListaDoble;
 ...
 * @author andre
 */
public class ListaDoble extends javax.swing.JFrame {

    private CListaDoble lista;
    /**
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        Boolean resultado = lista.Buscar(txtDato.getText());
        if(!resultado){
...
private void Limpiar(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaDoble.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
